                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child: Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Padding(padding: getPadding(left: 60), child: Text("lbl_enter_details".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtArialMT22Bluegray900))
                                                                              ])))
                                                            ])))),
                                            Container(
                                                              ...
                                                              child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    GestureDetector(
                                                                        ...
                                                                        child: Container(
                                                                            margin:
                                                                                getMargin(left: 2, top: 74),
                                                                            padding: getPadding(left: 100, top: 14, right: 100, bottom: 14),
                                                                            decoration: AppDecoration.txtFillOrangeA200.copyWith(borderRadius: BorderRadiusStyle.txtCircleBorder25),
                                                                            child: Text("lbl_continue2".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtRobotoBold16WhiteA700)))
                                                                  ])))
                                                    ]))
                                          ]))
                                ])))))));
